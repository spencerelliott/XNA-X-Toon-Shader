...
namespace PrimitivesSample
{
    ...
    public class PrimitiveBatch : IDisposable
    {
        ...
        public PrimitiveBatch(GraphicsDevice graphicsDevice)
        {
            ...
            //float _aspectRatio = (float)graphicsDevice.Viewport.Width / (float)graphicsDevice.Viewport.Height;
            //basicEffect.Projection = Matrix.CreatePerspectiveFieldOfView(MathHelper.PiOver4, _aspectRatio,
            //                                                        Camera.NEAR_CLIPPING_DISTANCE, Camera.FAR_CLIPPING_DISTANCE);
        }
